  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved coach as @coach" do
        ...
        post :create, {:coach => { "fnkp_code" => "invalid value" }}, valid_session
        assigns(:coach).should be_a_new(Coach)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested coach" do
        ...
        Coach.any_instance.should_receive(:update).with({ "fnkp_code" => "MyString" })
        put :update, {:id => coach.to_param, :coach => { "fnkp_code" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the coach as @coach" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Coach.any_instance.stub(:save).and_return(false)
        put :update, {:id => coach.to_param, :coach => { "fnkp_code" => "invalid value" }}, valid_session
        assigns(:coach).should eq(coach)
      end
